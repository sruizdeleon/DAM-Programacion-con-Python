'''
Docstring para actividades.actividad01.ejercicio01.utilidades
...
def pedir_booleano(instruccion: str) -> bool:
    "Pide un booleano al usuario en formato 1=true o 0=false hasta que se proporcione uno y lo devuelve."
    while True:
        texto = input(instruccion)
        try:
            entero = int(texto)
