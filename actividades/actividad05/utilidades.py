...
def pedir_opciones(instrucion: str, opciones: list):
    ...
    while True:
        ...
        if texto in opciones:
            return texto
        print("ERROR: no has introducido una opción válida.")
...
def pedir_entero_entre(instruccion: str, minimo: int, maximo: int) -> int:
    ...
    while True:
        ...
        try:
            entero = int(texto)
            if entero < minimo:
                print("ERROR: has proporcionado un número menor al mínimo")
            elif entero > maximo:
                print("ERROR: has proporcionado un número mayor al máximo")
            else:
                return entero
        except ValueError:
            print("ERROR: no has proporcionado un número entero válido (Ejemplo: 1)")
